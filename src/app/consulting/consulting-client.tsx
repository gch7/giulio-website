        ...
        <section ref={heroRef} className="w-full bg-[#fafafa] py-24 px-6 md:px-12">
          <div className="max-w-[1200px] mx-auto text-center">
            <div ref={badgeRef} className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#0d9488]/10 border border-[#0d9488]/20 rounded-full mb-8">
              ...
              <span className="text-[12px] font-medium text-[#0d9488] tracking-wide uppercase">Expert Advisory</span>
            </div>
            ...
            <div className="flex flex-col gap-6">
              {[
                ...
                <div key={index} className="step-item flex gap-5 items-start">
                  <div className="w-10 h-10 bg-white border border-[#e4e4e7] text-[#0d9488] rounded-lg flex items-center justify-center flex-shrink-0 text-[13px] font-semibold">
                    {item.step}
                  </div>
                  <div>
