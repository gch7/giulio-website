...
import { Mail, ChevronDown, Send, Loader2, CheckCircle, AlertCircle } from 'lucide-react';
              ...
              <div ref={formRef} className="bg-white border border-[#e4e4e7] rounded-xl p-7 md:p-8">
                ...
                {submitStatus === 'success' && (
                  <div className="mb-6 p-4 bg-[#0d9488]/10 border border-[#0d9488]/20 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[14px] font-medium text-[#0d9488]">Message sent successfully!</p>
                      <p className="text-[13px] text-[#0d9488]/80">We&apos;ll get back to you within 24-48 hours.</p>
                    </div>
                  </div>
                )}
                ...
                {submitStatus === 'error' && (
                  <div className="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-[14px] font-medium text-red-600">Failed to send message</p>
                      <p className="text-[13px] text-red-500">Please try again or email us directly.</p>
                    </div>
                  </div>
                )}
                ...
                <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                  ...
                  <button 
                    ...
                    className="form-field w-full bg-[#0a0a0b] text-white py-3.5 rounded-md text-[14px] font-semibold hover:bg-[#27272a] transition-colors mt-2 inline-flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                  >
                    {isSubmitting ? (
                      <>
