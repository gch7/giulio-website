        ...
        <section ref={heroRef} className="w-full bg-[#fafafa] py-24 px-6 md:px-12">
          <div className="max-w-[1200px] mx-auto text-center">
            <div ref={badgeRef} className="inline-flex items-center gap-2 px-3 py-1.5 bg-[#0d9488]/10 border border-[#0d9488]/20 rounded-full mb-8">
              ...
              <span className="text-[12px] font-medium text-[#0d9488] tracking-wide uppercase">Discord Community</span>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 items-stretch">
                ...
                <div className="flex flex-col p-6 sm:p-8 bg-gradient-to-br from-[#0a0a0b]/0 via-[#0a0a0b]/[0.06] to-[#0a0a0b]/0 max-w-xl rounded-2xl m-8 relative shadow-[inset_0_1px_0_rgba(0,0,0,0.02)] gap-6">
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                    ...
                    {billing === 'annual' && (
                      <span className="inline-flex items-center rounded-full border border-[#0d9488]/30 bg-[#0d9488]/10 px-2 py-0.5 text-[11px] tracking-tight text-[#0d9488]">
                        Save 20%
                      </span>
                    )}
                  </div>
                    ...
                    <div className="mt-6">
                      {selectedPlan === 'institutional' ? (
                        ...
                        <button 
                          ...
                          disabled={isLoading}
                          className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-[#0a0a0b] text-white hover:bg-[#27272a] h-11 px-5 ring-1 ring-[#0a0a0b]/20 text-sm font-medium transition shadow-sm disabled:opacity-70 disabled:cursor-not-allowed"
                        >
                          {isLoading ? (
                            <>
