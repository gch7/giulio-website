          ...
          <div className="max-w-[800px] mx-auto">
            <div className="bg-gradient-to-br from-[#f0fdfa] to-[#ecfdf5] rounded-2xl p-6 md:p-10 border border-[#0d9488]/20">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-[22px] md:text-[28px] font-semibold text-[#0a0a0b]">
                  Coming Soon
                </h2>
              </div>

              <p className="text-[14px] md:text-[15px] text-[#52525b] mb-5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-5">
                {comingSoonFeatures.map((feature, index) => (
                  <div key={index} className="flex items-center gap-2">
                    ...
                    <span className="text-[13px] md:text-[14px] text-[#3f3f46]">{feature}</span>
                  </div>
                ))}
              </div>

              <p className="text-[13px] md:text-[14px] text-[#0d9488] font-medium">
          ...
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {keyBenefits.map((benefit, index) => (
                <div key={index} className="benefit-card bg-white rounded-2xl p-5 md:p-6 border border-[#e4e4e7] hover:border-[#0d9488]/30 hover:shadow-lg transition-all duration-300">
                  <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-[#0d9488]/10 to-[#0d9488]/5 rounded-xl flex items-center justify-center mb-4 md:mb-5">
                    <benefit.icon className="w-5 h-5 md:w-6 md:h-6 text-[#0d9488]" />
                  </div>
                  <h3 className="text-[16px] md:text-[18px] font-semibold text-[#0a0a0b] mb-2">
                    {benefit.title}
                  </h3>
