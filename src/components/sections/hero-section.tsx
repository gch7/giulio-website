      ...
      <section ref={sectionRef} className="sm:px-6 lg:px-8 md:py-24 w-full max-w-7xl mx-auto pt-16 px-4 pb-20 relative" style={{ zIndex: 1 }}>
        <div style={{ zIndex: 1 }}>
          <div ref={badgeRef} className="flex items-center justify-center">
            <span className="inline-flex items-center gap-2 text-[11px] uppercase tracking-wide border rounded-full px-3 py-1 text-[#52525b] bg-[#0a0a0b]/5 border-[#0a0a0b]/10">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5 text-[#9a7b1a]">
          ...
          <div ref={titleRef} className="text-center max-w-3xl mt-6 mx-auto">
            <h1 className="md:text-6xl text-4xl font-semibold text-[#0a0a0b] tracking-tight">Market Intelligence for</h1>
            <h2 className="text-4xl md:text-6xl font-semibold tracking-tight text-[#0a0a0b] mt-1">
              <span className="bg-clip-text text-transparent italic font-['Playfair_Display'] bg-gradient-to-r from-[#52525b] via-[#9a7b1a] to-[#c9a227]">
            ...
            <div ref={buttonsRef} className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              <div className="relative inline-block group">
                ...
                <span 
                  ...
                  style={{
                    background: 'radial-gradient(60% 100% at 50% 50%, rgba(154,123,26,.35), rgba(154,123,26,.18) 35%, transparent 70%)',
        ...
        <div ref={cardsRef} className="grid grid-cols-1 lg:grid-cols-3 gap-4 w-full mt-20">
          <Link href="/solutions/strategy-insights" className="group relative border border-[#0a0a0b]/10 rounded-xl p-7 bg-white/60 backdrop-blur-xl hover:border-[#0a0a0b]/20 hover:bg-white/80 card-hover flex flex-col h-full transition-all duration-300">
            ...
            <div className="flex items-center gap-2 text-[#9a7b1a] font-medium text-[13px]">
          ...
          <Link href="/memberships" className="group relative border border-[#0a0a0b]/10 rounded-xl p-7 bg-white/60 backdrop-blur-xl hover:border-[#0a0a0b]/20 hover:bg-white/80 card-hover flex flex-col h-full transition-all duration-300">
            <div className="w-10 h-10 bg-[#0a0a0b]/5 border border-[#0a0a0b]/10 rounded-lg flex items-center justify-center mb-5">
              <svg className="w-5 h-5 text-[#9a7b1a]" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div ref={statsRef} className="mt-20 pt-16 border-t border-[#e4e4e7]">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
            <div className="text-center stat-item">
              <div className="text-[32px] md:text-[40px] font-semibold text-[#0a0a0b] tracking-tight stat-number">500+</div>
              <div className="text-[13px] text-[#a1a1aa] mt-1 uppercase tracking-wider">Active Members</div>
            </div>
            <div className="text-center stat-item">
              <div className="text-[32px] md:text-[40px] font-semibold text-[#0a0a0b] tracking-tight stat-number">$2.1B</div>
              <div className="text-[13px] text-[#a1a1aa] mt-1 uppercase tracking-wider">AUM Advised</div>
            </div>
            <div className="text-center stat-item">
              <div className="text-[32px] md:text-[40px] font-semibold text-[#0a0a0b] tracking-tight stat-number">12+</div>
              <div className="text-[13px] text-[#a1a1aa] mt-1 uppercase tracking-wider">Years Experience</div>
            </div>
            <div className="text-center stat-item">
              <div className="text-[32px] md:text-[40px] font-semibold text-[#0a0a0b] tracking-tight stat-number">94%</div>
              <div className="text-[13px] text-[#a1a1aa] mt-1 uppercase tracking-wider">Client Retention</div>
            </div>
          </div>
        </div>
      </section>
