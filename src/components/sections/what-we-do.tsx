...
import { BarChart3, Users, Building2, Network, ArrowRight, Rocket, type LucideIcon } from 'lucide-react';
...
const defaultServices: ServiceCardType[] = [
  {
    _key: 'service-1',
    icon: 'BarChart3',
      ...
      <div className="max-w-[1200px] mx-auto">
        ...
        {content.showViewAllButton && (
          <div className="text-center mt-12">
            <Link
              href={content.viewAllButtonHref || '/solutions'}
            ...
            >
              {content.viewAllButtonText || 'View All Solutions'}
